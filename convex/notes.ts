...
// Internal mutation to create a note and its embeddings transactionally
...
// Mutation to delete a note and its associated embeddings
export const deleteNote = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    // Delete embeddings concurrently for better performance
